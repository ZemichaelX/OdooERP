...
# The LOGIN page's own checks — button states included — live in
# scripts/lib/check_login_page.py and run through verify_login_page below, so
# the demo and a real client tenant are held to one definition.
